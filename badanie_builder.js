...
const hard_words = ["błąd", "północ", "działanie", "brak", "obcy", "radość", "ruch", "polecenie", "pamięć", "atak", "siła", "wszystko", "wiatr", "pytanie", "związek", "zgoda", "światło", "rozdział", "zawartość", "wyrok", "kraj", "źródło", "świadomość", "dno", "prawda", "przyjaciel", "całość", "możliwość", "rzeczywistość", "rzecz", "dane", "system", "spokój", "wypadek", "wzrok", "skutek", "wina", "trzask", "oddech", "gniew", "punkt", "rozkaz", "smak", "wyraz", "cisza", "sposób", "sytuacja", "tydzień", "umysł", "zwycięstwo", "naród", "spacer", "środek", "tom", "szef", "wpływ", "czas", "sen", "lewo", "litość", "praca", "reszta", "odgłos", "obowiązek", "szczęście", "zapach", "temat", "nazwisko", "honor", "dół", "miłość", "dział", "przykład", "szkoda", "centrum", "próba", "rozpacz", "spotkanie", "prawo", "fragment", "rok", "przestrzeń", "ciepło", "zamiar", "los", "wiadomość", "wstyd", "porządek", "osoba", "kawałek", "południe", "pomysł", "bok", "miejsce", "dźwięk", "ciekawość", "sprawa", "słowo", "fakt", "szum", "głód", "ilość", "chłód", "chwila", "opór", "koniec", "zło", "podróż", "potrzeba", "uwaga", "cud", "przyszłość", "dar", "śmierć", "krzyk", "rodzina", "pora", "rozmowa", "rada", "strach", "widok", "ogół", "dzień", "ciemność", "kształt", "ból", "obecność", "ego", "przyjaźń", "gra", "głos", "towarzysz", "moment", "plan", "powietrze", "echo", "hałas", "kochanie", "problem", "pomoc", "interes", "kurs", "cześć", "historia", "stan", "zdanie", "cel", "uczucie", "moc", "postać", "udział", "ton", "grupa", "panna", "różnica", "materiał", "życie", "część", "cokolwiek", "pułkownik"];
const easy_words = ["twarz", "wschód", "pogoda", "wóz", "złoto", "mięso", "ogień", "wino", "rzeka", "tłum", "róg", "oko", "dym", "nos", "tekst", "dama", "mag", "ptak", "wybuch", "piasek", "klucz", "księżyc", "ślad", "spodnie", "morze", "sąd", "włosy", "maszyna", "usta", "działo", "chłopiec", "ksiądz", "kościół", "smok", "ziemia", "krok", "pistolet", "krąg", "mieszkanie", "śnieg", "drzewo", "oczy", "kot", "kula", "język", "schody", "serce", "błysk", "połowa", "niebo", "fotel", "korytarz", "film", "brzuch", "strój", "duch", "głowa", "łuk", "komputer", "las", "pies", "ręka", "laboratorium", "stół", "pociąg", "woda", "ogon", "pierś", "żołnierz", "dach", "pole", "człowiek", "drzwi", "jezioro", "napis", "worek", "ucho", "strumień", "kapitan", "czoło", "ubranie", "armia", "dziecko", "diabeł", "król", "brzeg", "miasto", "ciało", "mózg", "wieczór", "wojna", "palec", "ekran", "książka", "blask", "telefon", "policjant", "rana", "majątek", "szczyt", "wilk", "zachód", "koło", "krzyż", "budynek", "papier", "mur", "silnik", "zegar", "łóżko", "gardło", "wieś", "płaszcz", "plac", "mgła", "broń", "pokój", "noc", "samolot", "statek", "dom", "sufit", "miecz", "kapelusz", "nóż", "skóra", "mężczyzna", "okulary", "słońce", "samochód", "uśmiech", "ogród", "dłoń", "zamek", "chłopak", "obraz", "most", "doktor", "kieliszek", "deszcz", "rycerz", "krew", "cień", "profesor", "obóz", "dziewczyna", "znak", "zdjęcie", "piwo", "brwi", "burza", "łódź", "zwłoki", "okno", "chleb", "krzesło", "kamień", "ostrze", "plecy", "numer"];
...
psychoJS.schedule(psychoJS.gui.DlgFromDict({
    dictionary: expInfo,
    title: "Proszę poczkeać na załadowanie zasobów",
}));
...
flowScheduler.add(quitPsychoJS, 'Dziękuję za udział w badaniu!', true);

// quit if user presses Cancel in dialog box:
dialogCancelScheduler.add(quitPsychoJS, 'Dziękuję za udział w badaniu!', false);
...
async function experimentInit() {
  ...
  text = new visual.TextStim({
    win: psychoJS.window,
    name: 'text',
    text: 'Teraz będą dwie próby z informacją o poprawności wykonania zadania',
    font: 'Arial',
    units: undefined, 
  ...
  text_2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_2',
    text: 'Z jakiego urządzenia korzystasz w celu wypełnienia badania?',
    font: 'Arial',
    units: undefined, 
  ...
  text_4 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_4',
    text: 'Teraz rozpocznie się główna część badania gdzie już nie będzie informacji zwrotnej o poprawności wykonania zadania.',
    font: 'Arial',
    units: undefined, 
    ...
    text_email = new visual.TextStim({
        win: psychoJS.window,
        name: 'text_email',
        text: 'Jesteś osobą, która otrzymała niski wynik na kwestionariuszu związanego z wobraźnie wizualną w pierwszej części badania. To wskazuje, że możesz mieć afantazję. Afantazja jest bardzo, rzadkim przypadkiem poniżej 3% procent społeczeństwa ją ma, dlatego trudno znajduje się takie osoby do badań. Będziemy wdzięczni jeśli wpiszesz poniżej swój adres email abyśmy mogli się z tobą skontaktować w przyszłych celach badawczych.',
        font: 'Arial',
        units: undefined,
  ...
  text8 = new visual.TextStim({
    ...
    text_czy_git = new visual.TextStim({
        win: psychoJS.window,
        name: 'text_czy_git',
        text: 'Czy dobrze i wyraźnie widziałeś/aś wszyskie bodźce?',
        font: 'Arial',
        units: undefined,
        pos: [0, 0.4], draggable: false, height: 0.06, wrapWidth: 1.5, ori: 0.0,
        languageStyle: 'LTR',
    ...
    czy_rzet = new visual.TextStim({
        win: psychoJS.window,
        name: 'czy_rzet',
        text: 'Czy wykonałeś/aś badanie rzetelnie? Zaznaczenie "Nie" nie będzie wiązało się z żadnymi konsekwencjiami, a pomoże w analizach.',
        font: 'Arial',
        units: undefined,
        pos: [0, 0.4], draggable: false, height: 0.06, wrapWidth: 1.5, ori: 0.0,
        languageStyle: 'LTR',
